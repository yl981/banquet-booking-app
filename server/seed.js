...
const seedData = async () => {
  try {
    ...
    console.log('Seeding Luxury Banquet Venues...');
    const sampleVenues = [
      {
    ...
    console.log(`Inserted ${createdVenues.length} luxury banquet venues.`);
    ...
    await Booking.create({
      user: demoCustomer._id,
      venue: createdVenues[0]._id,
      eventDate: new Date(Date.now() + 15 * 24 * 60 * 60 * 1000), // 15 days in future
      eventType: 'Weddings',
